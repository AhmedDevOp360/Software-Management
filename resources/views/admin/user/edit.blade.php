            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" placeholder="Lorem ipsum"
                ...
                <!-- Submit Button -->
                <div class="text-end">
                    <a href="{{ route('admin.users.index') }}" class="bg-gray-500 text-white px-8 py-3 rounded-lg hover:bg-gray-600 transition-colors mr-2 inline-block">Cancel</a>
                    <button type="submit"
